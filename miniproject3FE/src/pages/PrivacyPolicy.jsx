  ...
  return (
    <div className="privacy-policy-page">
      ...
      <ul>
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ShePlays: Football.</li>
        ...
        <li><strong>Website</strong> refers to ShePlays: Football, accessible from <a href="http://www.sheplaysfootball.com" target="_blank" rel="noopener noreferrer">www.sheplaysfootball.com</a>.</li>
      ...
      <ul>
        ...
        <li><strong>To contact You:</strong> to contact You by email, telephone calls, SMS, or other forms of communication.</li>
